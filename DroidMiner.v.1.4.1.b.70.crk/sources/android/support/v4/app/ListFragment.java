...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00132();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00121();
    ...
    class C00132 implements OnItemClickListener {
        C00132() {
        }
